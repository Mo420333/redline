...
export default function Events() {
  ...
  const field =
    'rounded-lg border border-slate-300 bg-white px-4 py-2.5 text-sm text-slate-900 outline-none focus:border-redline focus:ring-2 focus:ring-redline/15'
            ...
            {visible.map((e, idx) => {
              ...
              return (
                <Reveal
                  key={e.id}
                  delay={(idx % 3) * 80}
                  className="group flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-1 hover:border-redline/50 hover:shadow-md"
                >
