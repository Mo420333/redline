...
export default function Giveaways() {
  ...
  return (
    <section id="giveaways" className="bg-slate-50 py-20 sm:py-28">
          ...
          {GIVEAWAYS.map((g, idx) => {
            ...
            return (
              <Reveal
                key={g.id}
                delay={idx * 90}
                className={`relative flex flex-col overflow-hidden rounded-3xl border p-7 shadow-sm ${
                  g.featured
                    ? 'border-redline/40 bg-gradient-to-br from-redline/10 to-white ring-1 ring-redline/20 lg:col-span-3'
                    : 'border-slate-200 bg-white'
                }`}
              >
                <div className="absolute -right-8 -top-8 h-28 w-28 rounded-full bg-redline/10 blur-2xl" />
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`rounded-full px-3 py-1 text-xs font-bold ${
                        urgent ? 'bg-redline text-white' : 'bg-slate-100 text-slate-600'
                      }`}
                    >
                ...
                <h3 className="relative mt-5 text-lg font-bold text-slate-900">{g.prize}</h3>
                <p className="relative text-sm text-slate-500">{g.sponsor}</p>
                ...
                <button
                  ...
                  className={`relative mt-6 rounded-xl px-5 py-3 font-semibold transition ${
                    isIn
                      ? 'cursor-default border border-redline/40 bg-redline/10 text-redline'
